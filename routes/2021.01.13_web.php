...
Route::get('estadisticas/configuracion/{type}', 'StatisticsController@list')->where('type', 'produccion|indicadores')->middleware('auth')->name("statistics.list"); 
...
Route::get('estadisticas/{type}', 'StatisticsController@resume')->where('type', 'produccion|indicadores')->middleware('auth')->name("statistics.resume"); 
...
//Manual
Route::get('estadisticas/manual', 'StatisticsController@manual')->middleware('auth')->name("statistics.manual_data"); ; 
