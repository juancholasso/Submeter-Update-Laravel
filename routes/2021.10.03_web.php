...
Route::get('estadisticas/configuracion/{type}/modificar', 'StatisticsController@update')->where('type', 'produccion|indicadores')->middleware('auth')->name("statistics.updatevalid");
...
Route::get('estadisticas/{type}', 'StatisticsController@resume')->where('type', 'produccion|indicadores')->middleware('auth')->name("statistics.resumevalid");
